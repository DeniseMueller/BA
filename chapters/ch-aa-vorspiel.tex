...
\begin{tabbing}
          Stuttgart, den \workDatum ~~	\= \rule{5cm}{0.3mm}\\
                                                                                                    \> Unterschrift
\end{tabbing}
%
\newpage
...
Die nachfolgende Bachelorarbeit enthält vertrauliche Daten der IT-Designers GmbH.
Veröffentlichungen oder Vervielfältigungen dieser Arbeit -- auch nur auszugsweise -- sind ohne ausdrückliche Genehmigung der IT-Designers GmbH nicht gestattet.
